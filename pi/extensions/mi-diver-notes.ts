...
import { createLockedDivernoteRunner } from '../../src/tactics-journal-context.ts';
...
const absoluteRunner = createLockedDivernoteRunner(
  (_file, args, options) => adapterRunner(DIVERNOTE_COMMAND, args, options),
);
