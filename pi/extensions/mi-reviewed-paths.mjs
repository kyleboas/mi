...
export function reviewedMiExtensionPaths({ root, daemonPath, capabilityGuardPath, capabilityAdapterPath, requireDaemon = false, requireGuard = false, requireAdapter = false } = {}) {
