...
Check useful local context if available:
- ~/pi-docs/wiki/goals.md
- ~/pi-docs/wiki/projects.md
- ~/pi-docs/wiki/services.md
- recent git/GitHub state only if safe and available
