...
const unsupportedReply = `Diver Notes currently supports ${supportedSurface}; listing subtasks, documents, details, manuals, interviews, lifecycle operations, and raw API access are unavailable.`;
const ambiguousReply = `Which supported Diver Notes item do you mean: a task, note, project, project task, or subtask?`;
