...
for source in \
  ...
  "$repo_dir/gateway/wait-for-llm-gateway-health" \
...
install -m 0755 "$repo_dir/gateway/wait-for-llm-gateway-health" /usr/local/libexec/wait-for-llm-gateway-health
...
/usr/local/libexec/wait-for-llm-gateway-health /home/kyle/bin/llm-gateway-health
