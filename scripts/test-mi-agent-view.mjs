...
assert.match(cli, /startPiTuiScreen\(new FunctionScreen\(renderAgentLines, onData\), \{ clearScreen: false \}\)/, 'mi-agents does not use the alternate screen so tmux scrollback works');
assert.match(cli, /only repainting changed rows, which avoids mi-agents flicker/, 'agent view documents why it uses pi-tui differential rendering');
