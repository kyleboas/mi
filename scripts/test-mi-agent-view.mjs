...
assert.match(cli, /fullLastOutput && task[\s\S]*renderPiLastOutputMessage\(fullLastOutput \|\| 'No result yet\.', width\)[\s\S]*terminal\/tmux scrollback[\s\S]*lines\.push\(\.\.\.outputLines\)/, 'full last output mode renders complete output for native scrollback');
