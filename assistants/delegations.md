...
|---|---|---|---:|---|---|
| mi-service-restart | restart_mi_owned_service | mi-daemon.service, mi-web-chat.service, mi-tick.timer, mi-photon-bridge.service | 4 | service is active or timer listed after restart | delegated |
